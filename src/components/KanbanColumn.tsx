        ...
        {adding ? (
          <form onSubmit={submit} className="space-y-2">
            ...
            <div className="flex gap-2">
              <button type="submit" className="inline-flex items-center justify-center gap-1.5 border-[3px] border-brut-ink bg-primary px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-primary-foreground shadow-[3px_3px_0_0_hsl(0_0%_0%)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_0_hsl(0_0%_0%)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0_0_hsl(0_0%_0%)] transition-all duration-150">
                <Plus size={13} strokeWidth={2.5} />
                Add
              </button>
              <button type="button" onClick={() => setAdding(false)} className="inline-flex items-center justify-center gap-1.5 border-[3px] border-brut-ink bg-card px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-foreground shadow-[3px_3px_0_0_hsl(0_0%_0%)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_0_hsl(0_0%_0%)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0_0_hsl(0_0%_0%)] transition-all duration-150">
