...
export default function RemindersBanner() {
  ...
  return (
    <div className="border-b-[3px] border-brut-ink bg-gradient-to-r from-primary/80 via-primary/50 to-brut-wishlist/20 px-6 py-2.5">
      ...
      <div className="space-y-1">
        {overdue.map((r, i) => (
          <div key={r.id} className="flex items-center gap-2 py-0.5">
            ...
            <button onClick={() => complete(r.id)} className="ml-auto inline-flex items-center justify-center gap-1.5 border-[3px] border-brut-ink bg-card px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-foreground shadow-[3px_3px_0_0_hsl(0_0%_0%)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_0_hsl(0_0%_0%)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0_0_hsl(0_0%_0%)] transition-all duration-150">
